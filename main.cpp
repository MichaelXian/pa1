...
int main() {
   PNG png1,result1;
   png1.readFromFile("../images/rosegarden.png"); // Temp for testing
   result1.readFromFile("../images/rosegarden.png"); //  Temp for testing
   ...
   result1.writeToFile("../images/out-blocktest.png"); // Temp for testing
...
//chain
   // to-do: add tests for insert back 
